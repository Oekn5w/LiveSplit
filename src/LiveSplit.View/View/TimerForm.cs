...
public partial class TimerForm : Form
{
    ...
    private void LoadRun()
    {
        ...
        if (CurrentState.CurrentPhase != TimerPhase.NotRunning)
        {
            result = MessageBox.Show(this, "Run ist still active.\r\nContinue to load a run nevertheless?", "Overwrite active run?", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
